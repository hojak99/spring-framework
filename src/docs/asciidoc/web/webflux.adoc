...
<<webflux-webclient.adoc#builder-options,can be configured>> directly. For all other
...
[[webflux-multipart]]
==== Multipart data
[.small]#<<webmvc.adoc#multipart-resolver,Same in Spring MVC>>#
...
and `java.nio.ByteBuffer` (see <<include::core/core-databuffer-codec.adoc, Data Buffers and Codecs>>).
